...
- **primary_goal**: 透過七類索克拉底提問（含「重構 Reframing」），協助用戶將口語化的工程問題形式化為 TRIZ 矛盾句，為後續的矛盾收斂圖分析做準備。
...
1. **矛盾輸入區**
   ...
   - section_purpose: 透過七類索克拉底提問（澄清、假設挑戰、證據追問、觀點轉換、因果追問、後果探索、重構 Reframing），讓用戶輸入或 AI 輔助生成矛盾的自然語言描述，並將其轉化為 TRIZ 矛盾句。
...
- **elements**:
  ...
  - `七類索克拉底提問輔助`: `expandable panel`, `optional`, `展開後顯示 AI 基於七類提問（澄清、假設挑戰、證據追問、觀點轉換、因果追問、後果探索、重構）生成的引導性問題，協助用戶深入思考矛盾本質。重構 (Reframing) 提問可建議用戶重新定義問題邊界。`
...
- **主要互動流程**：
  ...
  2. 用戶在矛盾輸入區輸入自然語言描述，可展開「七類索克拉底提問輔助」面板，AI 根據七類提問（澄清、假設挑戰、證據追問、觀點轉換、因果追問、後果探索、重構）生成引導問題，協助用戶釐清矛盾。
...
- [x] 七類索克拉底提問輔助面板可正確展開，顯示 AI 生成的引導問題（含「重構 Reframing」類型）。
- [x] 矛盾列表支援按嚴重度排序與篩選。
