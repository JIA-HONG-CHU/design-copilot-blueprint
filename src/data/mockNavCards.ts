...
export function getMockNavCards(progress: PhaseProgress): NavCardDef[] {
  ...
  const gate12 = progress["1.2"] === "passed";
  const gate13 = progress["1.3"] === "passed";
  const gate21 = progress["2.1"] === "passed";
  const gate22 = progress["2.2"] === "passed";
  ...
  return [
    ...
    },
    {
      ...
      phase: "Phase 1",
      icon: "Compass",
      route: "contradiction-identification",
      subSteps: 2,
